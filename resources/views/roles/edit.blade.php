                                    ...
                                    <tr>
                                        ...
                                        @foreach($accesslist as $access)
                                            @if(isset($accesses["$access"]))
                                                <td>{{ Form::checkbox('permission[]', $accesses["$access"]->id, in_array($accesses["$access"]->id, $rolePermissions) ? true : false, array('class' => 'checkbox '  . "$access $module")) }}</td>
                                            @else
                                                <td></td>
                                            @endif 
                                        @endforeach  
                            ...
                            <tbody>  
                                @foreach($accessquestion as $module=>$accesses)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch">
                                                {{ Form::checkbox('permission[]', $access->id, in_array($access->id, $rolePermissions) ? true : false, array('class' => 'checkbox '  . "$accessName $module")) }}
